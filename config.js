...
const SESSION_ID = process.env.SESSION_ID || "A-S-W-I-N-S-P-A-R-K-Y:ddc5360794c7afee0e5c9c31a4ac0a56";
...
const BOT_INFO = process.env.BOT_INFO || "Professor X;Lewis;https://i.imgur.com/r3GZeiX.jpeg";
const URL = process.env.URL || "https://www.instagram.com/absolutely_sparky";
const AUDIO_DATA = process.env.AUDIO_DATA || "Professor X;Lewis;https://i.imgur.com/fVCRCYG.jpeg";
const STICKER_DATA = process.env.STICKER_DATA || "Professor X;Lewis";
